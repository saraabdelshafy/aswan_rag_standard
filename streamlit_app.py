...
=====================================================================
معالجة مشكلة الشاشة السوداء على Streamlit Cloud:
وحدات الـ RAG التقيلة (موديل الـ embeddings + بناء مخزن Chroma) كانت
تُحمَّل لحظة استيراد الملف فتُعلّق التطبيق قبل رسم أي عنصر.
الآن كل وحدة تُحمَّل "كسولاً" عند الحاجة فقط، والواجهة تُرسم دائماً،
وأي خطأ يظهر داخل الصفحة نفسها بدل الشاشة الفارغة.
الخط الكامل:
